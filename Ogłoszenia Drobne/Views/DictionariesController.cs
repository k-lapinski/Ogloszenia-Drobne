...
namespace Ogłoszenia_Drobne.Views
{
    public class DictionariesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] Dictionary dictionary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] Dictionary dictionary)
        {
            if (ModelState.IsValid)
            {
